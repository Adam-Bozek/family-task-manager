...
const KidDashboard = () => {
  ...
  const handleConfirm = () => {
    setTasks((prevTasks) =>
      prevTasks.map((task) =>
        task.id === selectedItem.id ? { ...task, status: "waiting" } : task // Zmení stav úlohy na "waiting"
      )
    );
        ...
        <div className={styles.content}>
          <section className={styles.tasks}>
            ...
            <div className={styles.legend}>
              ...
              <div className={styles.legendItem}>
                <span className={`${styles.circle} ${styles.notDone}`} />{" "}
                Nesplnené
              </div>
              <div className={styles.legendItem}>
                <span className={`${styles.circle} ${styles.waiting}`} /> Čaká
                na potvrdenie
              </div>
              <div className={styles.legendItem}>
        ...
        <div className={styles.content}>
          <section className={styles.rewards}>
            ...
            <div className={styles.rewardsList}>
              <button className={`${styles.rewardButton} ${styles.done}`}>
                Sladkosť
              </button>
              <button className={`${styles.rewardButton} ${styles.waiting}`}>
                5€
              </button>
            </div>
            ...
            <div className={styles.legend}>
              ...
              <div className={styles.legendItem}>
                <span className={`${styles.circle} ${styles.waiting}`} />{" "}
                Čakajúce na splnenie
              </div>
            </div>
          </section>
        </div>
