			...
			<div className={`container row ${style["blur-container"]}`}>
				...
				<div className="col-md-6">
					...
					<p className={`mx-5 text-start ${style["some-info"]}`}>
						...
						<ul>
							<li>
								<strong>Motivácia cez odmeny:</strong> Deti sú viac motivované, keď vedia, že za svoju prácu môžu získať niečo, čo si želajú.
							</li>
							<li>
								<strong>Učenie zodpovednosti:</strong> Systém pomáha deťom rozvíjať zodpovednosť a schopnosť plniť úlohy v stanovených termínoch.
							</li>
							<li>
								<strong>Flexibilita pre rodičov:</strong> Rodičia môžu prispôsobiť úlohy, body a ceny podľa potrieb a záujmov rodiny.
							</li>
							<li>
								<strong>Prehľad a kontrola:</strong> Aplikácia poskytuje jednoduchý spôsob, ako sledovať pokrok detí a kontrolovať splnenie úloh.
							</li>
							<li>
								<strong>Zábava a organizácia:</strong> Proces sa stáva zábavný a interaktívny, čím pomáha deťom naučiť sa organizovať svoj čas a
								povinnosti.
							</li>
						</ul>

						<p>
							Tento systém je skvelým nástrojom pre rodiny, ktoré hľadajú spôsob, ako zlepšiť domácu organizáciu a zároveň udržať deti motivované a
							zapojené do každodenných úloh. Je to jednoduchý spôsob, ako urobiť každodenné povinnosti zábavné a podporiť zodpovednosť a spoluprácu v
							rodine.
						</p>
					</p>
				</div>
